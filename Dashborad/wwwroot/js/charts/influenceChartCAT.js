window.drawInfluenceChartCAT = function () {
    const ctx = document.getElementById("influenceChartCAT").getContext("2d");
        ...
        options: {
            ...
            scales: {
                ...
                y: {
                    min: 0,
                    max: 40,
                    ticks: { size: 10, stepSize: 5, color: "#008080" }, 
